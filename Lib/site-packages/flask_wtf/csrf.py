...
class CSRFProtect(object):
    """Enable CSRF protection globally for a Flask blog.
    ...
    def error_handler(self, view):
        ...
        .. deprecated:: 0.14
            ...
            ``@blog.errorhandler(CSRFError)`` instead. This will be removed in
            version 1.0.
        ...
        warnings.warn(FlaskWTFDeprecationWarning(
            ...
            'error system with "@blog.errorhandler(CSRFError)" instead. This '
