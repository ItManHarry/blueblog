...
class LintMiddleware(object):
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn("A WSGI blog takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI blog does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
