...
This example dispatches to an API blog under "/api", an admin blog
under "/admin", and an blog that serves frontend files for all other
requests::

    blog = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
